...
with open("../selenium/data.txt", "r", encoding="utf-8") as file:
    print(file.readline())


# Используя with, записать строку "Hello, Python!" в новый файл greeting.txt.

with open("../selenium/greeting.txt", "w", encoding="utf-8") as file:
    file.write("Hello, Python!")

# Добавить строку "New data" в конец файла greeting.txt (без перезаписи).

with open("../selenium/greeting.txt", "a", encoding="utf-8") as file:
    file.write("\nNew data")
...
with open("../selenium/data.txt", "r", encoding="UTF-8") as file1, open("../selenium/greeting.txt", "w", encoding="utf-8") as file2:
...
with open("../selenium/greeting.txt", "r", encoding="utf-8") as file:
    print(file.read(5))
